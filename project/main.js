...
// 	xhr.overrideMimeType("appilcation/json");
...
// 	console.log(data);
// 	basic(data.details);
// 	carreerinfo(data.carrerobjective);
...
function basic(det){
	...
	email.href="mailto:kundananampuneethkrishna@gmail.com";
...
function education(edu){
	...
	heading1.textContent= "Educational Qualfication";
	...
	for(i=0;i<edu.length;i++){
		tabledata+="<tr><td>"+edu[i].institute+"</td><td>"+edu[i].degree+"</td><td>"+edu[i].passoutyear+"</td><td>"+edu[i].percentage+"</td><td>";
	   }
